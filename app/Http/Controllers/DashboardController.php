...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $kiba = KIBA::count('id_kiba');
        $kibb = KIBB::count('id_kibb');
        $kibc = KIBC::count('id_kibc');
        $kibd = KIBD::count('id_kibd');
        $kibe = KIBE::count('id_kibe');
        $barang_masuk = BarangMasuk::count('id_barang_masuk');
        $barang_keluar = BarangKeluar::count('id_barang_keluar');
        return view('dashboard', compact('barang', 'barang_masuk', 'barang_keluar','kiba' ,'kibb' ,'kibc' ,'kibd' ,'kibe'));
    }
