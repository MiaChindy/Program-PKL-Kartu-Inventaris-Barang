    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                ...
                <form action="/edtKIBC/<?php echo e($item->id_kibc); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kon_bangunan" name="kon_bangunan" value="<?php echo e($item->kon_bangunan); ?>">
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="luas_lantai" name="luas_lantai" value="<?php echo e($item->luas_lantai); ?>">
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <div class="mb-3">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\inventaris-barang\resources\views/kibc/edtKIBC.blade.php ENDPATH**/ ?>