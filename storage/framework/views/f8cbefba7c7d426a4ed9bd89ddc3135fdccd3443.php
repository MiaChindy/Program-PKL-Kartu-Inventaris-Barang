    ...
    <div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
        <div class="card card0 border-0">
                ...
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        <div class="row px-3 justify-content-center mt-3 mb-2 border-line"> <img
                                src="<?php echo e(asset('images/Kalsel.png')); ?>" width="200"> </div>
                        <div class="row justify-content-center text-center pb-0 pt-2 border-line">
                            <h4><b>Aplikasi Kartu Inventaris Barang Pada Dinas Kehutanan Provensi Kalimantan Selatan</b><br>
                                </h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-blue py-4">
                <div class="row px-3"> <small class="ml-4 ml-sm-5 mb-2">Copyright &copy; 2022. All rights
                        reserved.</small>
...
<?php /**PATH C:\xampp\htdocs\inventaris-barang\resources\views/auth/login.blade.php ENDPATH**/ ?>