                    ...
                    <table id="bootstrap-data-table" class="table table-striped table-bordered display nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/edtKIBB/<?php echo e($item->id_kibb); ?>" class="btn btn-sm btn-success"><i
                                            class="fa fa-pencil-square-o"></i></a>
                                    <a href="/hpsKIBB/<?php echo e($item->id_kibb); ?>" class="btn btn-sm btn-danger"><i
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\inventaris-barang\resources\views/kibb/dftKIBB.blade.php ENDPATH**/ ?>